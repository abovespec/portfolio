...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'makepicsmall',
    domain: 'makepicsmall.com',
    description: 'Free, instant image compression for JPG, PNG, WebP, AVIF, GIF and more — all in your browser, no uploads.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'makepicsmall',
    organizationUrl: 'https://makepicsmall.com',
    sameAs: [],
    contactEmail: 'hello@makepicsmall.com',
  },
  seo: {
    titleSeparator: ' | ',
