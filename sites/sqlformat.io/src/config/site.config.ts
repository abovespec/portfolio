...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'SQLFormat',
    domain: 'sqlformat.io',
    description: 'Free online sqlformat tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'SQLFormat',
    organizationUrl: 'https://sqlformat.io',
    sameAs: [],
    contactEmail: 'hello@sqlformat.io',
  },
  seo: {
    titleSeparator: ' | ',
