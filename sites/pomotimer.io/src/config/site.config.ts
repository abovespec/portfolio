...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'PomoTimer',
    domain: 'pomotimer.io',
    description: 'Free online pomotimer tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'PomoTimer',
    organizationUrl: 'https://pomotimer.io',
    sameAs: [],
    contactEmail: 'hello@pomotimer.io',
  },
  seo: {
    titleSeparator: ' | ',
