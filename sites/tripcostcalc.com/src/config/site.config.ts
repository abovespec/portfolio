...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'TripCostCalc',
    domain: 'tripcostcalc.com',
    description: 'Trip cost estimator by destination, packing list generator, visa requirement checker, and jet lag calculator.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#0284c7',
    accentColor: '#38bdf8',
    logoText: 'TripCostCalc',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'TripCostCalc',
    organizationUrl: 'https://tripcostcalc.com',
    sameAs: [],
    contactEmail: 'hello@tripcostcalc.com',
  },
  seo: {
    titleSeparator: ' | ',
