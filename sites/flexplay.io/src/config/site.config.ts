...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'FlexPlay',
    domain: 'flexplay.io',
    description: 'Interactive CSS Flexbox and Grid playground with live preview, visual cheat sheet, and copy CSS.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'FlexPlay',
    organizationUrl: 'https://flexplay.io',
    sameAs: [],
    contactEmail: 'hello@flexplay.io',
  },
  seo: {
    titleSeparator: ' | ',
