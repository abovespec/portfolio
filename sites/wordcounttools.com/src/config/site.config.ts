...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'WordCountTools',
    domain: 'wordcounttools.com',
    description: 'Free online word counter with character count, syllables, reading time, readability score, and keyword density.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#064e3b',
    accentColor: '#059669',
    logoText: 'WordCountTools',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'WordCountTools',
    organizationUrl: 'https://wordcounttools.com',
    sameAs: [],
    contactEmail: 'hello@wordcounttools.com',
  },
  seo: {
    titleSeparator: ' | ',
