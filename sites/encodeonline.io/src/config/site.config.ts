...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'EncodeOnline',
    domain: 'encodeonline.io',
    description: 'Free online Base64 encoder/decoder, MD5/SHA hash generator, URL encoder, and HTML entity tools.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#1e293b',
    accentColor: '#475569',
    logoText: 'EncodeOnline',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'EncodeOnline',
    organizationUrl: 'https://encodeonline.io',
    sameAs: [],
    contactEmail: 'hello@encodeonline.io',
  },
  seo: {
    titleSeparator: ' | ',
