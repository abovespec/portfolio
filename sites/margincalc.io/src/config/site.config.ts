...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'MarginCalc',
    domain: 'margincalc.io',
    description: 'Free profit margin, markup, and break-even calculators for entrepreneurs and small businesses.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'MarginCalc',
    organizationUrl: 'https://margincalc.io',
    sameAs: [],
    contactEmail: 'hello@margincalc.io',
  },
  seo: {
    titleSeparator: ' | ',
