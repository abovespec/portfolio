...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'FinanceCalc',
    domain: 'financalc.io',
    description: 'Free financial calculators including loan, mortgage, compound interest, ROI, and savings goal planners.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#312e81',
    accentColor: '#4f46e5',
    logoText: 'FinanceCalc',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'FinanceCalc',
    organizationUrl: 'https://financalc.io',
    sameAs: [],
    contactEmail: 'hello@financalc.io',
  },
  seo: {
    titleSeparator: ' | ',
