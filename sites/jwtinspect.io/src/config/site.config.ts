...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'JWTInspect',
    domain: 'jwtinspect.io',
    description: 'Free JWT decoder and inspector. Decode headers, payloads, verify signatures, and check token expiration.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'JWTInspect',
    organizationUrl: 'https://jwtinspect.io',
    sameAs: [],
    contactEmail: 'hello@jwtinspect.io',
  },
  seo: {
    titleSeparator: ' | ',
