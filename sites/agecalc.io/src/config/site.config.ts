...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'AgeCalc',
    domain: 'agecalc.io',
    description: 'Free online agecalc tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'AgeCalc',
    organizationUrl: 'https://agecalc.io',
    sameAs: [],
    contactEmail: 'hello@agecalc.io',
  },
  seo: {
    titleSeparator: ' | ',
