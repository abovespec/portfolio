...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'PercentCalc',
    domain: 'percentcalc.io',
    description: 'Free online percentcalc tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#a16207',
    accentColor: '#facc15',
    logoText: 'PercentCalc',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'PercentCalc',
    organizationUrl: 'https://percentcalc.io',
    sameAs: [],
    contactEmail: 'hello@percentcalc.io',
  },
  seo: {
    titleSeparator: ' | ',
