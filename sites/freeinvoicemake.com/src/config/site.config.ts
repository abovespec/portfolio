...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'FreeInvoiceMake',
    domain: 'freeinvoicemake.com',
    description: 'Free professional invoice generator. Create, customize, and download branded invoices instantly.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#1e293b',
    accentColor: '#3b82f6',
    logoText: 'FreeInvoiceMake',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'FreeInvoiceMake',
    organizationUrl: 'https://freeinvoicemake.com',
    sameAs: [],
    contactEmail: 'hello@freeinvoicemake.com',
  },
  seo: {
    titleSeparator: ' | ',
