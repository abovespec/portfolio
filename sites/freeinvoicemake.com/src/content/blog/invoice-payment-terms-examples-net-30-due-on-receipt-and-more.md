---
title: "Invoice Payment Terms Examples: Net 30, Due on Receipt, and More"
description: "Understand common invoice payment terms and which ones get you paid fastest."
publishDate: 2026-04-25
tags: ["payment terms", "invoice", "net 30", "freelancer"]
canonical: "invoice-payment-terms-examples-net-30-due-on-receipt-and-more"
---
...
**Use when:** Freelancing for small to mid-size companies.
**Risk:** Some corporate clients have policies against Net 15.

## Due on Receipt

Payment expected immediately upon receiving the invoice. Common for small projects and new clients.

**Use when:** Projects under $500 or first-time clients.
**Risk:** Can feel aggressive and strain new relationships.

## 50% Upfront, 50% on Delivery

Half the project fee before work starts, half upon completion. Standard in creative industries and web development.

**Use when:** Projects over $1,000 or with new clients.
**Risk:** Some clients refuse. Be willing to negotiate.

## Milestone Payments

Break large projects into phases. Invoice at the end of each phase. Common for projects lasting multiple months.

**Use when:** Projects over $5,000 or lasting 6+ weeks.
**Risk:** Requires clear scope definitions.
