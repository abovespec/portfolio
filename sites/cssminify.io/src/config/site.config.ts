...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'CSSMinify',
    domain: 'cssminify.io',
    description: 'Free online cssminify tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'CSSMinify',
    organizationUrl: 'https://cssminify.io',
    sameAs: [],
    contactEmail: 'hello@cssminify.io',
  },
  seo: {
    titleSeparator: ' | ',
