...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'GradientCSS',
    domain: 'gradientcss.io',
    description: 'Free CSS gradient generator with linear, radial, and conic gradients. Live preview and copy-ready CSS.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#581c87',
    accentColor: '#9333ea',
    logoText: 'GradientCSS',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'GradientCSS',
    organizationUrl: 'https://gradientcss.io',
    sameAs: [],
    contactEmail: 'hello@gradientcss.io',
  },
  seo: {
    titleSeparator: ' | ',
