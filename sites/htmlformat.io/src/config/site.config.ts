...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'HTMLFormat',
    domain: 'htmlformat.io',
    description: 'Free online htmlformat tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'HTMLFormat',
    organizationUrl: 'https://htmlformat.io',
    sameAs: [],
    contactEmail: 'hello@htmlformat.io',
  },
  seo: {
    titleSeparator: ' | ',
