...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'JSONFormat',
    domain: 'jsonformat.io',
    description: 'Format, validate, and convert JSON online. Free JSON formatter, validator, minifier, and converter with instant results.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'JSONFormat',
    organizationUrl: 'https://jsonformat.io',
    sameAs: [],
    contactEmail: 'hello@jsonformat.io',
  },
  seo: {
    titleSeparator: ' | ',
