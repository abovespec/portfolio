...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'UUIDGen',
    domain: 'uuidgen.io',
    description: 'Free online uuidgen tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'UUIDGen',
    organizationUrl: 'https://uuidgen.io',
    sameAs: [],
    contactEmail: 'hello@uuidgen.io',
  },
  seo: {
    titleSeparator: ' | ',
