...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'CrontabHelp',
    domain: 'crontab.io',
    description: 'Free online crontabhelp tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#6d28d9',
    accentColor: '#a78bfa',
    logoText: 'CrontabHelp',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'CrontabHelp',
    organizationUrl: 'https://crontab.io',
    sameAs: [],
    contactEmail: 'hello@crontab.io',
  },
  seo: {
    titleSeparator: ' | ',
