...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'PasswordGen',
    domain: 'passwordgen.io',
    description: 'Free online passwordgen tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
    themeColor: '#b91c1c',
    accentColor: '#f87171',
    logoText: 'PasswordGen',
    ogImageStrategy: 'static',
  },
  org: {
    organizationName: 'PasswordGen',
    organizationUrl: 'https://passwordgen.io',
    sameAs: [],
    contactEmail: 'hello@passwordgen.io',
  },
  seo: {
    titleSeparator: ' | ',
