...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'TipCalc',
    domain: 'tipcalc.io',
    description: 'Free online tipcalc tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'TipCalc',
    organizationUrl: 'https://tipcalc.io',
    sameAs: [],
    contactEmail: 'hello@tipcalc.io',
  },
  seo: {
    titleSeparator: ' | ',
