...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'UTMBuilder',
    domain: 'utmbuilder.io',
    description: 'Free UTM link builder for campaign tracking. Generate tagged URLs with preset shortcuts and history.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'UTMBuilder',
    organizationUrl: 'https://utmbuilder.io',
    sameAs: [],
    contactEmail: 'hello@utmbuilder.io',
  },
  seo: {
    titleSeparator: ' | ',
