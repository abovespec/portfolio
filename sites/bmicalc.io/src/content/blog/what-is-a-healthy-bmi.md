---
title: "What Is a Healthy BMI? Ranges, Categories, and What They Mean"
description: "Learn what a healthy BMI range is for adults, how the four official categories work, and why your number is a starting point—not a verdict."
...
- **Ethnicity.** Research has shown that people of Asian descent face increased metabolic risk at lower BMI values. The WHO has published alternative cut-points for Asian populations suggesting that health risks begin to rise at BMI ≥ 23 rather than ≥ 25. ([WHO — Appropriate body-mass index for Asian populations](https://www.who.int/publications/i/item/WHO-WPR-RBM-01.70))
...
- **Being significantly above the normal range** — particularly BMI above 30 — is associated with increased risk for hypertension, type 2 diabetes, sleep apnea, osteoarthritis, and several cancers. ([NIH — Health Risks of Overweight & Obesity](https://www.nhlbi.nih.gov/health/educational/lose_wt/risk.htm))

## Special Populations: When Standard Ranges Don't Apply

### Children and Teenagers
BMI is calculated the same way for children as for adults, but it is interpreted differently. Instead of fixed ranges, pediatric BMI is expressed as a **percentile** based on age and sex. A BMI at the 85th percentile or above is considered "at risk for overweight"; at or above the 95th percentile is classified as "obese." See our article [BMI for Children and Teens](/blog/bmi-for-children-and-teens/) for the full breakdown.
