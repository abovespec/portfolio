...
export const siteConfig: SiteConfig = {
  identity: {
    name: 'FaviconGen',
    domain: 'favicongen.io',
    description: 'Free online favicongen tool — no signup, instant results in your browser.',
    language: 'en',
    timezone: 'UTC',
  },
  branding: {
  ...
  org: {
    organizationName: 'FaviconGen',
    organizationUrl: 'https://favicongen.io',
    sameAs: [],
    contactEmail: 'hello@favicongen.io',
  },
  seo: {
    titleSeparator: ' | ',
